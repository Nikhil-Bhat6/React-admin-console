...
const StudentShow = props => (
	...
	<ReferenceManyField label="Parent" reference="parents" target="admission number">
                <SingleFieldList>
                    <TextField source="pname" />
	        </SingleFieldList>
	</ReferenceManyField>
	<ReferenceManyField label="Profession" reference="parents" target="admission number">
                <SingleFieldList>
                    <TextField source="profession" />
	        </SingleFieldList>
	</ReferenceManyField>
	<ReferenceManyField label="Email" reference="parents" target="admission number">
                <SingleFieldList>
                    <TextField source="email" />
	        </SingleFieldList>
	</ReferenceManyField>
	<ReferenceManyField label="Phone" reference="parents" target="admission number">
                <SingleFieldList>
                    <TextField source="phone" />
	        </SingleFieldList>
	</ReferenceManyField>
	<ReferenceManyField label="Relationship" reference="parents" target="admission number">
                <SingleFieldList>
                    <TextField source="relationship" />
	        </SingleFieldList>
	</ReferenceManyField>
	<ReferenceManyField label="Date of Birth" reference="parents" target="admission number">
                <SingleFieldList>
                    <TextField source="dob" />
	        </SingleFieldList>
	</ReferenceManyField>
	<ReferenceManyField label="Blood Group" reference="parents" target="admission number">
                <SingleFieldList>
